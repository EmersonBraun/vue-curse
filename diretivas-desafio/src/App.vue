<template>
	<div id="app">
		...
		<p v-quando:mouseenter="mouseEnter">Mouse enter Event</p>
		<p v-quando:mouseout="mouseOut">Mouse out Event</p>
	</div>
</template>
...
export default {
	...
	methods: {
		...
		mouseEnter(){
			console.log('event enter mouse')
		},
		mouseOut(){
			console.log('event out mouse')
		},
	},
}
</script>
